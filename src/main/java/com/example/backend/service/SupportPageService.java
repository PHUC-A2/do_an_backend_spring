...
public class SupportPageService {
    ...
    public List<ResSupportContactDTO> listContacts() {
        return supportContactRepository.findAll().stream()
    ...
    public ResSupportContactDTO createContact(ReqSupportContactDTO req) {
        ...
        if (e.getSortOrder() == null) {
            e.setSortOrder(supportContactRepository.findMaxSortOrder() + 1);
        }
    ...
    public void deleteContact(Long id) throws IdInvalidException {
        if (!supportContactRepository.existsById(id)) {
            throw new IdInvalidException("Không tìm thấy liên hệ hỗ trợ");
        }
    ...
    public List<ResSupportIssueGuideDTO> listIssueGuides() {
        return supportIssueGuideRepository.findAll().stream()
    ...
    public ResSupportIssueGuideDTO createIssueGuide(ReqSupportIssueGuideDTO req) {
        ...
        applyGuide(e, req);
        if (e.getSortOrder() == null) {
            e.setSortOrder(supportIssueGuideRepository.findMaxSortOrder() + 1);
        }
    ...
    public void deleteIssueGuide(Long id) throws IdInvalidException {
        if (!supportIssueGuideRepository.existsById(id)) {
            throw new IdInvalidException("Không tìm thấy hướng dẫn sự cố");
        }
        supportIssueGuideRepository.deleteById(id);
    }
    ...
    public List<ResSupportResourceLinkDTO> listResourceLinks() {
        return supportResourceLinkRepository.findAll().stream()
    ...
    public ResSupportResourceLinkDTO createResourceLink(ReqSupportResourceLinkDTO req) {
        ...
        applyLink(e, req);
        if (e.getSortOrder() == null) {
            e.setSortOrder(supportResourceLinkRepository.findMaxSortOrder() + 1);
        }
    ...
    public void deleteResourceLink(Long id) throws IdInvalidException {
        if (!supportResourceLinkRepository.existsById(id)) {
            throw new IdInvalidException("Không tìm thấy liên kết tài nguyên");
        }
        supportResourceLinkRepository.deleteById(id);
    }
    ...
    public List<ResSupportMaintenanceItemDTO> listMaintenanceItems() {
        return supportMaintenanceItemRepository.findAll().stream()
    ...
    public ResSupportMaintenanceItemDTO createMaintenanceItem(ReqSupportMaintenanceItemDTO req) {
        ...
        applyMaint(e, req);
        if (e.getSortOrder() == null) {
            e.setSortOrder(supportMaintenanceItemRepository.findMaxSortOrder() + 1);
        }
    ...
    public void deleteMaintenanceItem(Long id) throws IdInvalidException {
        if (!supportMaintenanceItemRepository.existsById(id)) {
            throw new IdInvalidException("Không tìm thấy mục bảo trì");
        }
        supportMaintenanceItemRepository.deleteById(id);
    }
