...
public class PublicPitchBookingService {
    ...
    public ResPitchTimelineDTO getPitchTimeline(
        ...
        List<ResPitchTimelineSlotDTO> slots = buildTimelineSlots(pitchId, date, slotMinutes, openTime, closeTime);
    ...
    private List<BookingTimeRange> getBookingRanges(
        ...
        return bookingRepository
                .findByPitchIdAndStartDateTimeLessThanAndEndDateTimeGreaterThanOrderByStartDateTimeAsc(
                        pitchId,
                        endOfDay,
                        startOfDay)
                .stream()
